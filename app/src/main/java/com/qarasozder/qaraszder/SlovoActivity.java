...
public class SlovoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvAddirional = findViewById(R.id.description_additional);
        ...
        switch (number) {
            ...
            case 38:
                ...
                tvAddirional.setText(getResources().getString(R.string.slovo38_additional));
                tvAddirional.setVisibility(View.VISIBLE);
                break;
            case 39:
